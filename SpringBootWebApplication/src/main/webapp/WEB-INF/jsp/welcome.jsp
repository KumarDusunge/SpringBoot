...
<body ng-app="myApp" ng-controller="myController">
	<form class="form-horizontal" name="myForm" ng-submit="submitMyForm()" action="save">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="firstName" name="firstName" type="text"
						ng-model="field.firstname" placeholder="Enter First Name"
						class="form-control input-md">
			...
			<!-- Text input-->
			<div class="form-group">
				<label class="col-md-4 control-label" for="middleName">Enter
					Middle Name</label>
				<div class="col-md-4">
					<input id="middleName" name="middleName" type="text"
						ng-model="field.middlename" placeholder="Enter Middle Name"
						class="form-control input-md">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="lastName" name="lastName" type="text"
						ng-model="field.lastname" placeholder="Enter Last Name"
						class="form-control input-md">
